...
def reversed_baekjoon_1078_new(D):
    ...
    if first_figure == 0:
        ...
        zero_counter = 0
        loop_target = target
        while (loop_target % 10 == 0):
            loop_target = loop_target // 10
            zero_counter = zero_counter + 1
        sub_result = reversed_baekjoon_1078_new(loop_target)
        result_format = 10 ** (get_figure_num(sub_result)-1+zero_counter*2)
        return_result = result_format + sub_result * (10 ** zero_counter) + 1
        ...
        fourth_start_num = unit_figure_num * 100
        fourth_limit_num = fourth_start_num + unit_figure_num
        ...
        if(return_result == -1):
            return_result = check_loop_method(target, fourth_start_num, fourth_limit_num)
        ...
        unit_figure_num = 1 * 10 ** (figure_num-1)
        first_start_num = unit_figure_num * 1 * result_higher
        first_limit_num = first_start_num + unit_figure_num
        
        second_start_num = unit_figure_num * 10 * result_higher
        second_limit_num = second_start_num + unit_figure_num

        third_start_num = unit_figure_num * 100 * result_higher
        third_limit_num = third_start_num + unit_figure_num

        fourth_start_num = unit_figure_num * 1000 * result_higher
        fourth_limit_num = fourth_start_num + unit_figure_num
